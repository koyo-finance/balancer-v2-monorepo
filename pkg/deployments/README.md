...
[![GitHub Repository](https://img.shields.io/badge/github-deployments-lightgrey?logo=github)](https://github.com/koyo-finance/exchange-vault-monorepo/tree/deployments-latest/pkg/deployments)
...
Addresses and ABIs can be consumed from the package in JavaScript environments, or manually retrieved from the [GitHub](https://github.com/koyo-finance/exchange-vault-monorepo/tree/master/pkg/deployments) repository.
