...
import { CustomChain, EtherscanNetworkEntry } from '@nomiclabs/hardhat-etherscan/dist/src/types';
...
export default class Verifier {
  ...
  constructor(_network: Network, _apiKey: string, _customChains: CustomChain[]) {
    this.network = _network;
    this.apiKey = _apiKey;
    this.customChains = _customChains;
  }
  ...
  async call(
    ...
    if (response.isVerificationSuccess()) {
      ...
      const contractURL = new URL(`/address/${address}#code`, etherscanAPIEndpoints.urls.browserURL);
