...
contract GPv2Settlement is GPv2Signing, ReentrancyGuard, StorageAccessible {
    ...
    using GPv2Transfer for IVaultCoW;
    ...
    IVaultCoW public immutable vault;
    ...
    constructor(GPv2Authentication authenticator_, IVaultCoW vault_) {
    ...
    function swap(
        IVaultCoW.BatchSwapStep[] calldata swaps,
        IERC20[] calldata tokens,
        ...
        IVaultCoW.SwapKind kind = order.kind == GPv2Order.KIND_SELL
            ? IVaultCoW.SwapKind.GIVEN_IN
            : IVaultCoW.SwapKind.GIVEN_OUT;

        IVaultCoW.FundManagement memory funds;
